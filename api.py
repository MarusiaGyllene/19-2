...
class PetFriends:
    ...
    def post_new_pet_no_photo(self, auth_key: json, name: str, animal_type: str,
                         age: str) -> json:
    ...
    def get_api_key(self, email: str, password: str):
        ...
        с уникальным ключём, найденного по указанным email и паролем"""
        headers = {
            'email': email,
            'password': password,
        }
    ...
    def put_pet_update_info(self, auth_key: json, pet_id: str, name: str,
    ...
    def post_pet_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
